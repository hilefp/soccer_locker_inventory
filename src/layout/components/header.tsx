...
export function Header() {
  ...
  return (
    <header
      className={cn(
        'header fixed top-0 z-10 start-0 flex items-stretch shrink-0 border-b border-transparent bg-soccer_locker_bg end-0 pe-[var(--removed-body-scroll-bar-size,0px)]',
