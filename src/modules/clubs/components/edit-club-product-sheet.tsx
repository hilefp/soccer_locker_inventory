...
export function EditClubProductSheet({
  ...
  useEffect(() => {
    if (clubProduct) {
      ...
      const pfnField = clubProduct.customFields?.find((f) => f.key === 'playerFirstName');
      setPlayerFirstName(!!pfnField);
      setPlayerFirstNameRequired(pfnField?.required ?? true);
            ...
            <div className="space-y-6 pr-4">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <Label htmlFor="sheetPlayerFirstName">Field Player First Name</Label>
                      <p className="text-xs text-muted-foreground">
                        Controls Show the field player first name on the product
                      </p>
                    </div>
                    <Switch
                      id="sheetPlayerFirstName"
                  ...
                  {playerFirstName && (
                    <div className="flex items-center justify-between pl-4 py-2 pr-2 ml-2 rounded-md bg-muted/50 border-l-2 border-primary/30">
                      <div className="space-y-0.5">
                        <Label htmlFor="sheetPlayerFirstNameReq" className="text-sm font-medium text-primary/80">Required</Label>
                        <p className="text-xs text-muted-foreground">
                          {playerFirstNameRequired ? 'Customer must fill this field' : 'Optional for the customer'}
                        </p>
                      </div>
                      <Switch
                        id="sheetPlayerFirstNameReq"
